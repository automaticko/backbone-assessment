...
class Settlement implements SettlementInterface
{
    ...
    private const FIELD_ZONE_TYPE       = 'zone';
    private const FIELD_SETTLEMENT_TYPE = 'type';
    ...
    public function settlementType(): SettlementTypeInterface
    {
        $fields = Collection::make([
            self::FIELD_SETTLEMENT_TYPE => $this->raw->get(self::FIELD_SETTLEMENT_TYPE),
        ]);

        return App::make(SettlementType::class, ['raw' => $fields]);
    }
}
